...
S = [ceil(start(1)/map.xy_res)-map.boundary_min(1)+1 ceil(start(2)/map.xy_res)-map.boundary_min(2)+1 ceil(start(3)/map.z_res)-map.boundary_min(3)+1];
G = [ceil(goal(1)/map.xy_res)-map.boundary_min(1)+1 ceil(goal(2)/map.xy_res)-map.boundary_min(2)+1 ceil(goal(3)/map.z_res)-map.boundary_min(3)+1];
