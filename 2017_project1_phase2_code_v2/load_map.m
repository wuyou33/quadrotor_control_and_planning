...
data = textscan(fileID,'%s %f %f %f %f %f %f %f %f %f');
fclose(fileID);
...
% boundary 
boundary_xmin= data{2}(1)/xy_res;
boundary_ymin= data{3}(1)/xy_res;
boundary_zmin= data{4}(1)/z_res;
boundary_xmax= data{5}(1)/xy_res;
boundary_ymax= data{6}(1)/xy_res;
boundary_zmax= data{7}(1)/z_res;
